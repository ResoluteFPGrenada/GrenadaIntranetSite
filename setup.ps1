...
try{
    ...
    write-host "installing virtualenv on local machine."
...
<#
write-host "Please create scheduled task to run python manage.py prod in project directory."
read-host "Press any button to continue"
#>

# Create and Write to log.txt to show setup was successful. # 
